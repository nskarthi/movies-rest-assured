...
public class MovieNegativeTests {
	...
	public void givenNoToken_whenRequestingMovies_thenReturns401() {
        ...
        LogUtils.getLogger().info("Step 1: Setting up invalid token and starting the test");
	...
	public void givenInvalidToken_whenRequestingMovies_thenReturns401() {
        ...
        LogUtils.getLogger().info("Step 1: Setting up page and limit query params and starting the test");
	...
	public void givenInvalidMovieId_whenRequestingMovieInfo_thenStatusIs404() {
        ...
        LogUtils.getLogger().info("Step 1: Attempting to retrieve the movie with id " + movieId + " which does not exist");

        Response response = MovieActions.getMovieById(movieId);
        
        ExtentReportManager.log("Step 2: Validating the API response");
        LogUtils.getLogger().info("Step 2: Validating the API response");
	...
	public void givenInvalidMovieDetails_whenCreatingMovie_thenStatusIs404() {
        ...
        LogUtils.getLogger().info("Step 1: Creating a default movie without movie title");
	...
	public void givenInvalidMovieId_whenDeletingMovie_thenStatusIs404() {
        ...
        LogUtils.getLogger().info("Step 1: Calling FakerUtil's generateRandomMovieId to get a random movieId that does not exist");
        ...
        LogUtils.getLogger().info("Step 2: Attempting to delete the movie with id " + movieId + " which does not exist");
	...
	public void patchUpdateMovieTitleFailure() {
        ...
        LogUtils.getLogger().info("Step 2: Attempting to PATCH update the title of movie with id " + movieId + " which does not exist");
